...
class Form extends Base{
	...
	/**
	*将添加的表单字段列出，便于后台编辑数据读取
     */
	public $editFieldAttr = array(
        array('name'=>'id','title'=>'ID','type'=>'hidden','help'=>''),
        array('name'=>'uid','title'=>'UID','type'=>'text','help'=>''),
        array('name'=>'status','title'=>'status','type'=>'text','help'=>''),
        array('name'=>'info','title'=>'备注','type'=>'text','help'=>''),
        array('name'=>'feiyong','title'=>'金额','type'=>'decimal','help'=>''),
        array('name'=>'update_time','title'=>'更新时间','type'=>'datetime','help'=>''),
        array('name'=>'create_time','title'=>'创建时间','type'=>'datetime','help'=>''),
        array('name' => 'killtype', 'title'=>'类型', 'type'=>'select', 'option' => array('1'=>'支出','2'=>'收入'),'help'=>'array(\'1\'=>\'支出\',\'2\'=>\'收入\')'),
    );
